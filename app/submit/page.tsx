      ...
      <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <Alert className="mb-8 border-emerald-200 bg-emerald-50">
          ...
          <AlertDescription className="text-emerald-800">
            <strong>Fayda ID Verification Required:</strong> You must complete
            Fayda ID verification before submitting your startup for review.
            This ensures all startups meet legal requirements.
          </AlertDescription>
        </Alert>
                ...
                {[
                  {
                    step: 1,
                    title: 'Submission',
                    desc: 'Complete and submit your application',
                  },
                  {
                    step: 2,
                    title: 'Verification',
                    desc: 'Fayda ID and legal compliance check',
                  },
                  {
                    step: 3,
                    title: 'Review',
                    desc: 'Expert panel evaluates your startup',
                  },
                  {
                    step: 4,
                    title: 'Approval',
                    desc: 'Get listed in the directory',
                  },
                ].map((item) => (
