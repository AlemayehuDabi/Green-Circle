...
export default function StartupsPage() {
  ...
  const filteredStartups = mockStartups.filter((startup) => {
    ...
    const matchesSector = selectedSector === "all" || startup.sector.toLowerCase() === selectedSector
    const matchesLocation = selectedLocation === "all" || startup.location.toLowerCase().includes(selectedLocation)
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        {/* Page Header */}
        <div className="mb-8">
          <h1 className="mb-2 text-3xl font-bold text-gray-900">Startup Directory</h1>
          <p className="text-gray-600">
            Discover {mockStartups.length} verified startups approved under Ethiopia&apos;s national Startup Law
          </p>
        </div>
